...
<div class="my-20 mx-2 flex flex-col justify-center items-center">
    <div class="bg-white w-full md:w-1/4 shadow rounded-md p-5 mx-2">
        <div class="text-center">
            <h1 class="text-4xl font-bold mb-2 text-blue-600">Welcome Admin!</h1>
        ...
        <form action="{{ route('admin.login') }}" method="POST" class="mt-2">
            ...
            <button type="submit" class="mt-6 text-center w-full bg-blue-700 rounded-md text-white py-3 font-medium hover:bg-blue-600 transition">Login</button>

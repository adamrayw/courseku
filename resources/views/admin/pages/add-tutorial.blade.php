        ...
        <div class="bg-white shadow-md rounded-md p-4 md:w-96 w-full">
            <form action="/admin/add-tutorial" method="POST">
                ...
                <div class="my-4">
                    ...
                    <input type="text" name="commentid" class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300" placeholder="CommentID">
                </div>
                <div class="my-4">
                ...
                <div class="my-4">
                    ...
                    <textarea type="text" name="description" class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300" placeholder="Description"></textarea>
                </div>
                <div class="my-4">
                    <h2 class="text-gray-600 font-semibold mb-1">Author</h2>
                    <input type="text" name="author" class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300" placeholder="Author">
                </div>
                <div class="my-4">
                ...
                <div class="my-4">
                    ...
                    <input type="text" name="submitted_by" class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300" placeholder="Submitted By"></input>
                </div>
                <div class="my-4">

                            ...
                            @foreach ($tutorials as $tutorial)
                                <tr class="text-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-xs border">
                                        <span
                                            class="px-2 py-1 font-semibold leading-tight {{ $tutorial->status == 'Release' ? 'text-green-700 bg-green-100' : 'text-gray-700 bg-gray-100' }}  rounded-sm">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div x-data="{ showModal : false }" x-cloak>
                                                ...
                                                <div x-show="showModal"
                                                    ...
                                                    <!-- Modal -->
                                                    <div x-show="showModal"
                                                        class="bg-white h-96 overflow-y-scroll rounded-xl shadow-2xl p-6 w-auto mx-10"
                                                        ...
                                                        <div class="p-4 md:w-96 w-full">
                                                            <form action="/admin/manage-tutorials/{{ $tutorial->id }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">User ID
                                                                    </h2>
                                                                    <input type="text" name="user_id"
                                                                        ...
                                                                        value="{{ $tutorial->user_id }}">
                                                                </div>
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">Comment ID
                                                                    </h2>
                                                                ...
                                                                <div class="my-4">
                                                                    ...
                                                                    <p class="text-xs text-gray-500 mt-2">This tutorial in
                                                                        <span
                                                                            class="text-gray-500 font-bold">{{ $tutorial->course->name }}</span>
                                                                        course
                                                                    </p>
                                                                </div>
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">Tutorial
                                                                        Name</h2>
                                                                ...
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">Description
                                                                        (Optional)</h2>
                                                                ...
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">Submitted
                                                                        By</h2>
                                                                    <input type="text" name="submitted_by"
                                                                        class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300"
                                                                        placeholder="Submitted By"
                                                                        value=" {{ $tutorial->submitted_by }}">
                                                                </div>
                                                                <div class="my-4">
                                                ...
                                                <div x-show=" showModal"
                                                    ...
                                                    <div x-show="showModal"
                                                        ...
                                                        <div class="flex justify-center items-center mt-6">
                                                            ...
                                                            <form action="/admin/manage-tutorials" method="post">
                                                                @csrf

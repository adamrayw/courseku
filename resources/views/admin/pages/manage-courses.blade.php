...
@section('admin-title', 'Manage Courses')

@section('admin-content')
    <section class="mt-12 mb-20 px-4 md:px-12 w-full ml-0 md:ml-64">
        <div>
            <div class="mb-4">
                <h2 class="text-2xl font-bold text-gray-600">Manage Courses</h2>
            </div>
                            ...
                            @foreach ($courses as $course)
                                <tr class="text-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-xs border">
                                        <span
                                            class="px-2 py-1 font-semibold leading-tight {{ $course->status == 'Release' ? 'text-green-700 bg-green-100' : 'text-gray-700 bg-gray-100' }} rounded-sm">
                                            {{ $course->status }} </span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-sm border">
                                        <div class="flex items-center">
                                            <div class="flex items-center">
                                                    ...
                                                    <div x-show="showModal"
                                                        ...
                                                        <div x-show="showModal"
                                                            ...
                                                            <div class="flex items-center mb-3">
                                                                ...
                                                                <span class="font-bold block text-2xl ml-2">Edit
                                                                    Course</span>
                                                            </div>
                                                            <!-- Body 🍺 -->
                                                            <div class="p-4 md:w-96 w-full">
                                                                <form action="/admin/manage-courses/course" method="POST">
                                                                    @csrf
                                                                    <div class="mb-4">
                                                                        <h2 class="text-gray-600 font-semibold mb-1">Icon
                                                                        </h2>
                                                                        ...
                                                                        <p class="text-xs text-gray-400 mt-1 font-light">We
                                                                            recommended from <a class="underline"
                                                                                href="https://icons8.com/">icons8</a></p>
                                                                    </div>
                                                                    <div class="my-4">
                                                                        <h2 class="text-gray-600 font-semibold mb-1">Course
                                                                            Name</h2>
                                                                    ...
                                                                    <div class="my-4">
                                                                        <h2 class="text-gray-600 font-semibold mb-1">Slug
                                                                        </h2>
                                                ...
                                                <div class="mx-2"></div>
                                                <a href="/admin/manage-courses/{{ $course->id }}"
                        ...
                        <tbody class="bg-white">
                            @foreach ($categories as $category)
                                <tr class="text-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-xs border">
                                        <span
                                            class="px-2 py-1 font-semibold leading-tight {{ $category->status == 'Release' ? 'text-green-700 bg-green-100' : 'text-gray-700 bg-gray-100' }}  rounded-sm">
                                                    ...
                                                    <div x-show="showModal"
                                                        ...
                                                        <div class="p-4 md:w-96 w-full">
                                                            <form action="/admin/manage-courses/category" method="POST">
                                                                ...
                                                                <div class="my-4">
                                                                    <h2 class="text-gray-600 font-semibold mb-1">Category
                                                                        Name</h2>
                                                                    <input type="text" name="name"
                                                                        class="h-12 border w-full font-xs text-gray-500 app border-gray-300 p-2 rounded-md focus:outline-none focus:ring focus:ring-indigo-300"
                                                                        placeholder="Course name"

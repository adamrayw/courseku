...
<nav class=" bg-white shadow p-3">
    <div class="max-w-7xl mx-auto flex items-center flex-wrap">
        ...
        <button
            class="text-gray-600 inline-flex p-3 hover:bg-gray-600 hover:text-white transition rounded-lg lg:hidden ml-auto outline-none nav-toggler"
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative md:ml-4 ml-auto">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <div class="flex justify-between items-center">
                                <p
                                    class="bg-blue-500 text-white p-4 h-5 w-5 rounded-md flex justify-center items-center">
                                    {{ Auth()->user()->name[0] }} </p>
                        ...
                        <div x-show="dropdownOpen"
                            ...
                            <a href="/submit-tutorial"
                                class="block text-left px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white">
                            ...
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                ...
                                <button type="submit"
                                    class="w-full text-left px-4 py-2 text-sm capitalize text-red-600 hover:bg-red-500 hover:text-white"><i
                                        class="fas fa-sign-out-alt mr-1"></i> Keluar</button>
                            </form>
                        </div>
                    </div>
                @else
                    <a href="/register"
                        class="lg:inline-flex text-center lg:w-auto w-full px-4 md:ml-4 ml-0 mt-2 md:mt-0 py-2 rounded-lg text-white items-center justify-center bg-blue-500 hover:bg-blue-700 transition">
                        <span>Register</span>
                    </a>
                @endif
            </div>

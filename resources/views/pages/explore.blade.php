    ...
    <section class="mt-20 text-center max-w-5xl mx-auto px-4">
        ...
        <div>
            <form action="#" method="GET">
                <div class="flex text-gray-600 items-center mt-6 px-4 py-2 border-2 border-blue-500 shadow bg-white rounded-lg">
                    <input type="text" name="search" id="search" class="w-full border-0" placeholder='Cari "Python Dasar"' value="{{ old('search') }}">

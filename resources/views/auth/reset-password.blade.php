        ...
        <div class="bg-white w-full md:w-1/4 shadow rounded-md p-5 mx-2">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <button type="submit"
                        class="mt-2 text-center text-base w-full bg-blue-500 hover:bg-blue-700 transition rounded-md text-white py-3 font-medium hover:bg-gray-600 transition">RESET
                        PASSWORD</button>
                </form>

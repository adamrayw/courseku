<div class="flex ml-auto">
    ...
    <form wire:submit.prevent="{{ $dislike }}">
        ...
        <button type="submit" class=" text-lg mr-1 text-gray-600"><i class="{{ $like_status }} fa-thumbs-up "></i> {{count($data->votes)}}</button>
    </form>
    @else
    <div x-data="{ showModal : false }">
        <button @click="showModal = !showModal" class="text-lg text-gray-600"><i class="far fa-thumbs-up "></i> {{count($data->votes)}}</button>
    ...
    <form wire:submit.prevent="{{ $saved }}">
        ...
        <button type="submit" class="text-gray-600 text-lg  ml-4"><i class="{{ $save_status }} fa-bookmark mr-1 text-gray-600"></i> Save</button>
    </form>
    @else
    <div x-data="{ showModal : false }">
        <button @click="showModal = !showModal" class=" text-gray-600 text-lg ml-4"><i class="{{ $save_status }} fa-bookmark mr-1 text-gray-600"></i> Save</button>

    ...
    @foreach ($datas as $data)
        ...
        @if (Auth::check())
            ...
            <form wire:submit.prevent="{{ $dislike }}">
                ...
                <button type="submit" class="text-lg mr-2 text-gray-600"><i
                        class="{{ $like_status }} fa-thumbs-up fa-lg pr-1"></i> {{ count($data->votes) }}</button>
            </form>
        @else
            <div x-data="{ showModal : false }">
                <button @click="showModal = !showModal" class="text-lg mr-2 text-gray-600"><i
                        class="far fa-thumbs-up text-gray-600 fa-lg pr-1"></i> {{ count($data->votes) }}</button>
                ...
                <div x-show=" showModal"
                    ...
                    <div x-show="showModal" class="bg-white rounded-xl shadow-2xl p-6 w-full sm:w-5/12 mx-10"
                        ...
                        <h1 class="text-center my-6 text-xl">Login to like, bookmark, and comment this course.</h1>
        ...
        @if (Auth::check())
            <form wire:submit.prevent="{{ $saved }}">
                ...
                <button type="submit" class="text-gray-600 text-lg  ml-4"><i
                        class="{{ $save_status }} fa-bookmark mr-1 fa-lg"></i></button>
            </form>
        @else
            <div x-data="{ showModal : false }">
                <button @click="showModal = !showModal" class="text-lg ml-4"><i
                        class="{{ $save_status }} fa-bookmark mr-1 text-gray-600 fa-lg"></i></button>

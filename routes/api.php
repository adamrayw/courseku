...
Route::get('/explore', [ApiIndexHomeController::class, 'explore']);
...
Route::get('/language', [ApiIndexHomeController::class, 'language']);
...
Route::post('/submit', [ApiIndexHomeController::class, 'submit']);
